                ...
                <div class="card" style="width: 23rem; margin-top: 1rem; border-radius: 10px; cursor: pointer; border-color: none; height: fit-content; z-index: 1;">
                    ...
                    <div class="card-body" style="font-family: 'DM Sans';">
                        <a href="#" style="text-decoration: none;">
                            <h5 class="card-title" style="font-weight: 600; margin-left: -0.5rem; color: black;">{{$carts->cart_book_title}}</h5>
                        </a>
                        ...
                        <form id="add-to-cart-form-{{ $carts->id }}" action="{{ route('add.cart', ['id' => $carts->id]) }}" method="POST" style="display:none;">
                            @csrf
                        </form>
                        
                        <a href="#" onclick="event.preventDefault(); document.getElementById('add-to-cart-form-{{ $carts->id }}').submit();" style="color:black;">
                            

                            <i class="fas fa-cash-register" style="font-size: 20px; float: right; padding-top: 0.15rem;"></i>
                        </a>
